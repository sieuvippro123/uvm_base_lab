...
# DVE full session
# Saved on Wed Mar 17 17:52:40 2021
# Designs open: 1
...
# DVE version: Q-2020.03-1_Full64
# DVE build date: Apr 19 2020 21:35:11


#<Session mode="Full" path="/coasiasemi/project/dv/uvm_academy_output/sontd/lab_10/DVEfiles/session.tcl" type="Coverage">
...
gui_show_window -window ${CovTopLevel.1} -show_state maximized -rect {{0 23} {1919 1039}}
...
gui_open_cov  -hier {/coasiasemi/project/dv/uvm_academy_output/sontd/lab_10/sim/coverage/spi_slv_test_device_init.vdb}   -testdir {/coasiasemi/project/dv/uvm_academy_output/sontd/lab_10/sim/coverage/spi_slv_test_device_init.vdb} -autoopen False  -test { {/coasiasemi/project/dv/uvm_academy_output/sontd/lab_10/sim/coverage/spi_slv_test_device_init/test} } -merge {MergedTest}
...
## Load Exclusion File
gui_exclusion_file -file /coasiasemi/project/dv/uvm_academy_output/sontd/lab_10/DVEfiles/session.el -load 
#reload all efliles:
 gui_exclusion_file -file /coasiasemi/project/dv/uvm_academy_output/sontd/lab_10/all_exclusion.el -load
...
catch {gui_list_expand -id ${CoverageTable.1} spi_slv_top}
catch {gui_list_expand -id ${CoverageTable.1} spi_slv_top._spi_slv}
catch {gui_list_expand -id ${CoverageTable.1} spi_slv_top._spi_slv}
catch {gui_list_select -id ${CoverageTable.1} {spi_slv_top._spi_slv.spictrl}}

# Source 'CovDetail.1'
gui_src_value_annotate -id ${CovDetail.1} -switch false
gui_set_env TOGGLE::VALUEANNOTATE 0
gui_open_source -id ${CovDetail.1}  -matrix Branch -replace -active spi_slv_top._spi_slv.spictrl -type {Scope}  /coasiasemi/home/sontd/uvm_academy_labs/lab_10/rtl/spi_slv_ctrl.sv
gui_src_value_annotate -id ${CovDetail.1} -switch true
gui_set_env TOGGLE::VALUEANNOTATE 1
gui_view_scroll -id ${CovDetail.1} -vertical -set 210
...
gui_covdetail_select -id CovDetail.1 -region {spi_slv_top._spi_slv.spictrl} -type {Instance}
set selected [gui_list_get_selected -id CovDetail.1 -list {branch} -first ]
gui_list_select -id CovDetail.1 -list {branch} -unselect [lindex $selected 0] 
gui_list_select -id CovDetail.1 -list {branch} {Item7}
